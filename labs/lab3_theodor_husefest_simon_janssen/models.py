...
class ConvNet_Type4(nn.Module):
    ...
    def __init__(self, n_input_channels=3, n_output=10):
        ...
        self.conv1 = nn.Conv2d(in_channels=n_input_channels, out_channels=64, kernel_size=5, padding=2)
        self.conv1_1 = nn.Conv2d(in_channels=64, out_channels=64, kernel_size=5, padding=2)
        self.maxpool = nn.MaxPool2d(kernel_size=2, stride=2)
        ...
        self.fc3 = nn.Linear(in_features=64, out_features=n_output)
